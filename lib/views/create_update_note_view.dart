...
import 'package:abolfazlnotes/utilities.dart/dialogs/cannot_share_empty_note_dialog.dart';
import 'package:abolfazlnotes/utilities.dart/generics/get_arguments.dart';
          ...
          IconButton(
            onPressed: () async {
              if (_textController.text.isEmpty) {
                showCanNotShareEmptyNoteDialog;
              } else {
